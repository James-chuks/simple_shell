...
- HTTPS:
Some level of understanding to Git Commands will be very helpful


```c
git clone https://github.com/James-chuks/simple_shell.git
```

- SSH:

```
git clone git@github.com:James-chuks/simple_shell.git
```
...
- *James-Ude James * - [@James-chuks](https://github.com/James-chuks) 
